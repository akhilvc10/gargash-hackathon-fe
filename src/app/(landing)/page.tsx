		...
		<main className="mt-20 md:mt-32">
			<div className="max-w-3xl mx-auto text-center">
				...
				<p className="text-xl text-white/80 mb-12">
					Discover, finance, purchase, lease, rent and maintain cars entirely
					online through a single mobile and web app.
				</p>
				...
				{[
					{
						...
						description:
							"Browse thousands of vehicles and get AI-powered recommendations based on your preferences.",
					},
					{
						title: "Flexible Options",
						description:
							"Choose to buy, lease, or rent with transparent pricing and flexible payment plans.",
					},
					{
						title: "Seamless Experience",
						description:
							"Complete the entire process online from application to delivery, with continuous support.",
					},
				].map((feature, index) => (
					<div
						key={index}
